...
class TemplateNoOutboundRefsTest(unittest.TestCase):
    ...
    def _scan(self, text):
        ...
        from llmw.content.wiki_fixtures import TEMPLATE_OUTBOUND_PATTERNS
    ...
    def test_skill_file_refs_detected(self):
        text = "见 page-templates.md §一 与 lint-workflow.md §二\n且 SKILL.md、ref/、yzr-llm-wiki-management、OKF 都算"
